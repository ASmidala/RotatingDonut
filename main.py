from vpython import *
canvas(backgroundcolor= color.purple)
donut = ring(radius=0.5, thickness=0.25, color=vector(400, 100, 1))
ring(radius=0.55, thickness=0.25, color=vector(0.4, 0.2, 0))
...
while True:
    ...
    rad = rad + 0.005
    # donut.rotate(angle=red, axis=vector(0, 1, 0))
    # chocolate.rotate(angle=red, axis=vector(0, 1, 0))
    # rad = rad + = 0.005
